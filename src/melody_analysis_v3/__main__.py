"""CLI clonada para la versión experimental ``melody_analysis_v3``."""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Ruta donde guardar la gráfica del contorno melódico detectado (v3).",
    )
    parser.add_argument(
        "--sections-plot",
        type=Path,
        default=None,
        help="Ruta para guardar el espectrograma con las secciones (v3).",
    )
